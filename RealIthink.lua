...
local function MakeTab(window, text, robloxicon)
    ...
    button.Position = UDim2.new(0, 5, 0, 40 + (order - 1) * 40)
...
-- Register functions into Syntix module
Syntix.CreateWindow = CreateWindow
Syntix.MakeTab = MakeTab
Syntix.AddButton = AddButton
Syntix.CreateSection = CreateSection
Syntix.AddToggle = AddToggle
